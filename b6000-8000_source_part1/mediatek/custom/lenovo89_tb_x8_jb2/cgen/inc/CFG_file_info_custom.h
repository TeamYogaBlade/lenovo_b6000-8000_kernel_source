...
#include "../cfgfileinc/CFG_Custom_Hdcp_Key_File.h"
#include "../cfgdefault/CFG_Custom_Hdcp_Key_Default.h"
#endif
#include <stdio.h>
#ifdef __cplusplus
extern "C"
...
#ifdef MTK_MT8193_HDCP_SUPPORT
       { "/data/nvram/APCFG/APRDCL/Hdcp_Key_Table",   VER(AP_CFG_RDCL_FILE_HDCP_KEY_LID), CFG_FILE_CUSTOM_HDCP_KEY_REC_SIZE,
        CFG_FILE_CUSTOM_HDCP_KEY_REC_TOTAL, SIGNLE_DEFUALT_REC  ,    (char *)&stCustomHdcpKeyDefault, DataReset , NULL
        },  
#endif
    };
