...
#ifndef TPD_POWER_SOURCE_CUSTOM_VOL
#define TPD_POWER_SOURCE_CUSTOM_VOL	VOL_2800
#endif
...
reset_proc:
	...
	hwPowerOn(TPD_POWER_SOURCE_CUSTOM, TPD_POWER_SOURCE_CUSTOM_VOL, "TP");

#ifdef TOUCH_PULL_HIGH_POWER_ID
	hwPowerOn(TOUCH_PULL_HIGH_POWER_ID, TOUCH_PULL_HIGH_POWER_VOL, "TP");
#endif
...
#ifdef TOUCH_PULL_HIGH_POWER_ID
	hwPowerDown(TOUCH_PULL_HIGH_POWER_ID, "TP");
#endif
